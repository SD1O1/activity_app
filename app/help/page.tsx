    ...
    <main className="min-h-screen bg-white px-4 py-12">
      <div className="mx-auto max-w-3xl space-y-8 text-slate-700">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">How to join an activity</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">How to host an activity</h2>
          <ul className="list-disc space-y-2 pl-6 leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">Account issues</h2>
          <p className="leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">Safety tips</h2>
          <ul className="list-disc space-y-2 pl-6 leading-7">
